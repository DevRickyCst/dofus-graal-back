...
CREATE TABLE set_caracteristiques (
    id SERIAL PRIMARY KEY,
...
CREATE TABLE set_stuffs (
    ...
    bouclier_id INTEGER,
    arme_id INTEGER,
    FOREIGN KEY (chapeau_id) REFERENCES items(id) ON DELETE CASCADE,
    FOREIGN KEY (collier_id) REFERENCES items(id) ON DELETE CASCADE,
    FOREIGN KEY (anneau_1_id) REFERENCES items(id) ON DELETE CASCADE,
    FOREIGN KEY (anneau_2_id) REFERENCES items(id) ON DELETE CASCADE,
    FOREIGN KEY (ceinture_id) REFERENCES items(id) ON DELETE CASCADE,
    FOREIGN KEY (botte_id) REFERENCES items(id) ON DELETE CASCADE,
    FOREIGN KEY (bouclier_id) REFERENCES items(id) ON DELETE CASCADE,
    FOREIGN KEY (arme_id) REFERENCES items(id) ON DELETE CASCADE
);
...
CREATE TABLE sets (
    ...
    FOREIGN KEY (caracteristique_id) REFERENCES set_caracteristiques(id) ON DELETE CASCADE,
    FOREIGN KEY (stuff_id) REFERENCES set_stuffs(id) ON DELETE CASCADE
);
